...
import com.qh.venus.achilles.framework.config.GenConfig;
...
public class VelocityUtils {
	...
	public static VelocityContext prepareContext(GenTable genTable) {
		...
		velocityContext.put("permissionPrefix", getPermissionPrefix(businessName, StringUtils.uncapitalize(genTable.getClassName())));
	 ...
	 * @return 返回权限前缀
	 */
	public static String getPermissionPrefix(String businessName, String className) {
		return StringUtils.format("{}:{}", businessName, className);
	}
