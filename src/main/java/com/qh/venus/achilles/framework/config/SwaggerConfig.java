...
public class SwaggerConfig {
	...
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2).pathMapping("/dev-api")
				...
				// 扫描指定包中的swagger注解
				.apis(RequestHandlerSelectors.basePackage("com.qh.venus.achilles.sms.tool.swagger"))
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder()
				...
				// 作者信息
				.contact(new Contact(ptsConfig.getName(), null, null))
				// 版本
				.version("版本号:" + ptsConfig.getVersion()).build();
	}
}
