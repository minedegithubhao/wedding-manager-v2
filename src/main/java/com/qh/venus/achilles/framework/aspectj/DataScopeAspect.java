...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.qh.venus.achilles.framework.aspectj.lang.annotation.DataScope)")
    ...
    protected void handleDataScope(final JoinPoint joinPoint)
    {
        ...
        // 获取当前的用户
        AuthUser loginUser = SpringUtils.getBean(TokenService.class).getLoginUser(ServletUtils.getRequest());
