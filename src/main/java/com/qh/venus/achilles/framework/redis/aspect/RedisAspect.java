package com.qh.venus.achilles.framework.redis.aspect;
...
import com.qh.venus.achilles.framework.redis.annotation.RedisEvict;
...
public class RedisAspect {
	 ...
	 */
	@Pointcut("@annotation(com.qh.venus.achilles.framework.redis.annotation.RedisCache)")
	public void redisCachePoint() {
	}

	@Pointcut("@annotation(com.qh.venus.achilles.framework.redis.annotation.RedisEvict)")
